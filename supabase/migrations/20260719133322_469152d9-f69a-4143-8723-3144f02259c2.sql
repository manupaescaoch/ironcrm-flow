ALTER TABLE public.cronograma_envios
DROP CONSTRAINT IF EXISTS cronograma_envios_atividade_id_fkey;

ALTER TABLE public.cronograma_envios
ADD CONSTRAINT cronograma_envios_atividade_id_fkey
FOREIGN KEY (atividade_id)
REFERENCES public.cronograma_atividades(id)
ON DELETE SET NULL;
...
BEGIN
  ...
  IF p_delete THEN
    UPDATE public.cronograma_envios
       SET atividade_id = NULL
     WHERE atividade_id = ANY(p_ids);
