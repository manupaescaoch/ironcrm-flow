  ...
  return (
    <Card className="rounded-2xl border shadow-sm h-full">
      <CardHeader className="pb-1.5 pt-3 px-4">
        <CardTitle className="text-sm font-semibold">Diagnóstico da Semana</CardTitle>
      </CardHeader>
      <CardContent className="space-y-2 pb-3 px-4">
        <div className="flex gap-2.5">
          ...
          <p className="text-xs text-foreground/90 leading-snug">{diagnostico}</p>
        </div>
        <div className="flex gap-2.5">
          ...
          <div>
            <p className="text-xs font-medium">Dica estratégica</p>
